...
public final class DaggerMainApplication_HiltComponents_SingletonC {
  ...
  private static final class FragmentCImpl extends MainApplication_HiltComponents.FragmentC {
    ...
    private HealthServicesManager healthServicesManager() {
      return new HealthServicesManager(singletonCImpl.provideHealthServicesClientProvider.get(), singletonCImpl.provideApplicationCoroutineScopeProvider.get());
    }
  ...
  private static final class ActivityCImpl extends MainApplication_HiltComponents.ActivityC {
    ...
    public Map<Class<?>, Boolean> getViewModelKeys() {
      return LazyClassKeyMap.<Boolean>of(ImmutableMap.<String, Boolean>of(LazyClassKeyProvider.com_example_exercise_MainViewModel, MainViewModel_HiltModules.KeyModule.provide()));
    }
    ...
    private static final class LazyClassKeyProvider {
      static String com_example_exercise_MainViewModel = "com.example.exercise.MainViewModel";

      @KeepFieldType
      MainViewModel com_example_exercise_MainViewModel2;
    }
  }
  ...
  private static final class ViewModelCImpl extends MainApplication_HiltComponents.ViewModelC {
    ...
    public Map<Class<?>, javax.inject.Provider<ViewModel>> getHiltViewModelMap() {
      return LazyClassKeyMap.<javax.inject.Provider<ViewModel>>of(ImmutableMap.<String, javax.inject.Provider<ViewModel>>of(LazyClassKeyProvider.com_example_exercise_MainViewModel, ((Provider) mainViewModelProvider)));
    }
